...
class _AllCoursesState extends State<AllCourses> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return BaseView<AllCoursesModel>(
      onModelReady: (model) {
      model.getCourses(widget.courseName);
        _model = model;
      },
                                ...
                                child: LiquidPullToRefresh(
                                  ...
                                  child: GridView(
                                    ...
                                    children: List<Widget>.generate(
                                      ...
                                      (int index) {
                                        final int count = model.courses.length;
...
//                          widget.callBack();
  ...
  Future<void> _handleRefresh() async {
    _model.getCourses(widget.courseName);
  }
}
